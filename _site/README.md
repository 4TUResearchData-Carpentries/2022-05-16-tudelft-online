...
> this repo is made as the website for the workshop `2022-05-16-tudelft-online`.

> install `bundle add webrick` to run this website for ruby@3.1.1 (ruby 3 in general should work like this)
